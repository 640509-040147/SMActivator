    ...
    class Activator
    {
        ...
        public void Activation()
        {
            ...
            try
            {
                ...
                Console.WriteLine(" Generating file \"indata2.x64\"");
                ...
                System.Threading.Thread.Sleep(2000);
                Console.WriteLine(" \"indata2.x64\" is generated successfully.");
                Console.ForegroundColor = ConsoleColor.Blue;
                Console.WriteLine(" {0}", filePath);
                Console.ForegroundColor = ConsoleColor.Black;
                Console.WriteLine(" Copy indata2.x64 to SmartBreak installation folder.\n");
            }
            catch (Exception)
            {
                MessageBox.Show("Could not save registration data. Make sure that the directory from which you are executing has write permissions. ", "Activator error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
